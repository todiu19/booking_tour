                ...
                .authorizeHttpRequests(
                        auth ->
                                auth.requestMatchers("/auth/**")
                                        ...
                                        .permitAll()
                                        .requestMatchers(HttpMethod.GET, "/hotels", "/hotels/**")
                                        .permitAll()
                                        ...
                                        .authenticated()
                                        .requestMatchers(HttpMethod.POST, "/hotel-bookings")
                                        .authenticated()
                                        .requestMatchers(HttpMethod.GET, "/hotel-bookings/me")
                                        .authenticated()
                                        .requestMatchers(HttpMethod.PUT, "/hotel-bookings/*/cancel")
                                        .authenticated()
